	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="服务说明" prop="fuwushuoming" >
					<el-input v-model="ruleForm.fuwushuoming" placeholder="服务说明" clearable  :readonly="ro.fuwushuoming"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="服务说明" prop="fuwushuoming" >
					<el-input v-model="ruleForm.fuwushuoming" placeholder="服务说明" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="销量" prop="xiaoliang" style="display:none">
					<el-input v-model.number="ruleForm.xiaoliang" placeholder="销量" clearable  :readonly="ro.xiaoliang"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="销量" prop="xiaoliang" >
					<el-input v-model="ruleForm.xiaoliang" placeholder="销量" readonly></el-input>
				</el-form-item>
			</template>
			...
			init(id,type ) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='fuwushuoming'){
							this.ruleForm.fuwushuoming = obj[o];
							this.ro.fuwushuoming = true;
							continue;
						}
						if(o=='weizhi'){
					...
					this.ruleForm.yingyeshijian = '8:00-24:00'; 					this.ruleForm.onshelves = Number('1'); 					this.ruleForm.xiaoliang = Number('0'); 				}
