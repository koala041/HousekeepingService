	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.quxiaobianhao" label="取消编号" prop="quxiaobianhao" >
					<el-input v-model="ruleForm.quxiaobianhao" placeholder="取消编号" readonly></el-input>
				</el-form-item>
		...
		data() {
			...
			return {
				...
				rules: {
					...
					quxiaoshuoming: [
						{ required: true, message: '取消说明不能为空', trigger: 'blur' },
					],
					quxiaoshijian: [
					],
					sfsh: [
							...
							if(this.type=='cross'){
								...
								if(statusColumnName!='') {
									...
									if(statusColumnName && !statusColumnName.startsWith("[")) {
										var notUpdateColumn = 'dingdanzhuangtai'.split(',')
