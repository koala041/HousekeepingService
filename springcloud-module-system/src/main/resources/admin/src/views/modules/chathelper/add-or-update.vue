...
<template>
	<div class="addEdit-block">
		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="知识问题/关键词" prop="ask" >
					<el-input v-model="ruleForm.ask" placeholder="例如：保洁预约、订单改时间、售后退款、服务收费" clearable  :readonly="ro.ask"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="知识问题/关键词" prop="ask" >
					<el-input v-model="ruleForm.ask" placeholder="知识问题/关键词" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item class="textarea" v-if="type!='info'" label="标准答案/知识内容" prop="reply" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="10"
					placeholder="请输入平台标准答案，例如服务范围、收费规则、改约流程、售后处理方式。内容越真实完整，智能客服回答越准确。"
					v-model="ruleForm.reply" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.reply" label="标准答案/知识内容" prop="reply"  class="textBox">
