	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="预约日期" prop="yuyueriqi" >
					<el-input v-model="ruleForm.yuyueriqi" placeholder="预约日期" clearable  :readonly="ro.yuyueriqi"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="预约日期" prop="yuyueriqi" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="预约时段" prop="yuyueshiduan" >
					<el-input v-model="ruleForm.yuyueshiduan" placeholder="预约时段" clearable  :readonly="ro.yuyueshiduan"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="预约时段" prop="yuyueshiduan" >
					<el-input v-model="ruleForm.yuyueshiduan" placeholder="预约时段" readonly></el-input>
				</el-form-item>
				<el-form-item class="select" v-if="type!='info'"  label="服务状态" prop="fuwuzhuangtai" style="display:none">
					<el-select :disabled="ro.fuwuzhuangtai" v-model="ruleForm.fuwuzhuangtai" placeholder="请选择服务状态"  filterable>
						<el-option
				...
				<el-form-item class="select" v-if="type!='info'" label="员工账号" prop="yuangongzhanghao" >
					<el-select :disabled="ro.yuangongzhanghao" @change="yuangongzhanghaoChange" v-model="ruleForm.yuangongzhanghao" placeholder="请选择员工账号" filterable>
						<el-option
				...
				<el-form-item class="date" v-if="type!='info'" label="预计到达时间" prop="yujidaodashijian" >
					<el-date-picker
						...
						type="datetime"
						:readonly="ro.yujidaodashijian"
						placeholder="预计到达时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item class="input" v-else-if="ruleForm.yujidaodashijian" label="预计到达时间" prop="yujidaodashijian" >
					<el-input v-model="ruleForm.yujidaodashijian" placeholder="预计到达时间" readonly></el-input>
				</el-form-item>
			</template>
		...
		methods: {
			...
			init(id,type ) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					this.ruleForm.fuwuzhuangtai = '待服务'; 				}
				...
				this.fuwuzhuangtaiOptions = "已服务,待服务".split(',')
				var yuangongzhanghaoRefParams = {
					refConditionColumn: 'fuwuzhuangtai',
					
				}
				yuangongzhanghaoRefParams.refConditionQueryMethod = '='
				yuangongzhanghaoRefParams.refConditionValue = '空闲'
				this.$http({
					url: `option/fuwurenyuan/yuangongzhanghao`,
					method: "get",
					params: yuangongzhanghaoRefParams
				}).then(({ data }) => {
					if (data && data.code === 0) {
			...
			yuangongzhanghaoChange () {
				this.$http({
					url: `follow/fuwurenyuan/yuangongzhanghao?columnValue=`+ this.ruleForm.yuangongzhanghao,
					method: "get"
				}).then(({ data }) => {
					if (data && data.code === 0) {
							...
							if(this.type=='cross'){
								...
								if(statusColumnName!='') {
									...
									if(statusColumnName && !statusColumnName.startsWith("[")) {
										var notUpdateColumn = 'dingdanzhuangtai,dingdanzhuangtai,fuwuzhuangtai'.split(',')
