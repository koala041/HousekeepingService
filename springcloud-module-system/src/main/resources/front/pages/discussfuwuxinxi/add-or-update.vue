	...
	<view :style='{"minHeight":"100%","width":"100%","padding":"0","position":"relative","background":"#fff","height":"auto"}' v-if="showType==1">
		<form :style='{"width":"100%","padding":"24rpx 48rpx 24rpx 48rpx","background":"#fff","display":"block","height":"auto"}' class="app-update-pv">
			...
			<view :style='{"padding":"12rpx 20rpx 12rpx 20rpx","margin":"0 0 24rpx 0","borderColor":"#25252530","borderRadius":"0","borderWidth":"0 0 2rpx 0","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"100%","lineHeight":"60rpx","fontSize":"28rpx","color":"#000","fontWeight":"500"}' class="title">评论内容</view>
				<xia-editor ref="content" :style='{"minHeight":"300rpx","border":"0px solid #ffaa3380","padding":"0px","color":"#666","width":"100%","fontSize":"28rpx","height":"auto"}' v-model="ruleForm.content" placeholder="评论内容" @editorChange="contentChange"></xia-editor>
			</view>
			<view :style='{"padding":"12rpx 20rpx 12rpx 20rpx","margin":"0 0 24rpx 0","borderColor":"#25252530","borderRadius":"0","borderWidth":"0 0 2rpx 0","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"100%","lineHeight":"60rpx","fontSize":"28rpx","color":"#000","fontWeight":"500"}' class="title">评分</view>
	...
	export default {
		...
		methods: {
			...
			async onSubmitTap(subMitType=null) {
				...
				let rs2 = await this.$api.list('discussfuwuxinxi',{
					page: 1,
					limit: 10000,
